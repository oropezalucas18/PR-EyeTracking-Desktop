...
namespace Helpers.Controls
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IRangeSlider_Bindings
        {
            ...
            private static bool isobj77TickFrequencyDisabled = false;
            private static bool isobj77MinimumDisabled = false;
            private static bool isobj77MaximumDisabled = false;
            private static bool isobj77StepFrequencyDisabled = false;
            private static bool isobj78MinimumDisabled = false;
            private static bool isobj78MaximumDisabled = false;
            private static bool isobj78ValueDisabled = false;
            private static bool isobj78StepFrequencyDisabled = false;
            private static bool isobj78IsEnabledDisabled = false;
            private static bool isobj78ThumbToolTipValueConverterDisabled = false;
            private static bool isobj79MinimumDisabled = false;
            private static bool isobj79MaximumDisabled = false;
            private static bool isobj79ValueDisabled = false;
            private static bool isobj79StepFrequencyDisabled = false;
            private static bool isobj79ThumbToolTipValueConverterDisabled = false;
            ...
            {
                if (lineNumber == 474 && columnNumber == 13)
                {
                    isobj77TickFrequencyDisabled = true;
                }
                else if (lineNumber == 475 && columnNumber == 13)
                {
                    isobj77MinimumDisabled = true;
                }
                else if (lineNumber == 476 && columnNumber == 13)
                {
                    isobj77MaximumDisabled = true;
                }
                else if (lineNumber == 477 && columnNumber == 13)
                {
                    isobj77StepFrequencyDisabled = true;
                }
                else if (lineNumber == 483 && columnNumber == 13)
                {
                    isobj78MinimumDisabled = true;
                }
                else if (lineNumber == 484 && columnNumber == 13)
                {
                    isobj78MaximumDisabled = true;
                }
                ...
                {
                    isobj78StepFrequencyDisabled = true;
                }
                else if (lineNumber == 488 && columnNumber == 13)
                {
                    isobj78IsEnabledDisabled = true;
                }
                else if (lineNumber == 489 && columnNumber == 13)
                {
                    isobj78ThumbToolTipValueConverterDisabled = true;
                }
                else if (lineNumber == 494 && columnNumber == 13)
                {
                    isobj79MinimumDisabled = true;
                }
                else if (lineNumber == 495 && columnNumber == 13)
                {
                    isobj79MaximumDisabled = true;
                }
                else if (lineNumber == 496 && columnNumber == 13)
                {
                    isobj79ValueDisabled = true;
                }
                else if (lineNumber == 497 && columnNumber == 13)
                {
                    isobj79StepFrequencyDisabled = true;
                }
                else if (lineNumber == 499 && columnNumber == 13)
                {
                    isobj79ThumbToolTipValueConverterDisabled = true;
                }
                else if (lineNumber == 500 && columnNumber == 13)
                {
            ...
            private void Update_TickFrequency(global::System.Double obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    if (!isobj77TickFrequencyDisabled)
                    {
