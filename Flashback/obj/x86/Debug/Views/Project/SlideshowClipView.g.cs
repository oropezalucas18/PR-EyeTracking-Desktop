...
namespace Flashback.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            ISlideshowClipView_Bindings
        {
            ...
            {
                if (lineNumber == 173 && columnNumber == 37)
                {
            ...
            ISlideshowClipView_Bindings
        {
            ...
            private static bool isobj14ProgressObjectDisabled = false;
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 67 && columnNumber == 43)
                {
                ...
                else if (lineNumber == 185 && columnNumber == 83)
                {
                ...
                else if (lineNumber == 106 && columnNumber == 17)
                {
                    isobj14ProgressObjectDisabled = true;
                }
            }
            ...
            private void Update_PreviewMediaElementProgressObject(global::Helpers.Controls.ProgressObject obj, int phase)
            {
                ...
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    if (!isobj14ProgressObjectDisabled)
                    {
